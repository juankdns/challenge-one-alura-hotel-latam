...
public class LoginView extends JFrame {
	...
	public LoginView() {
		...
		imgHotel.setIcon(new ImageIcon(LoginView.class.getResource("/img/img-hotel-login-.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(LoginView.class.getResource("/img/lOGO-50PX.png")));
