...
public class BusquedaView extends JFrame {
	...
	public BusquedaView() {
		...
		panel.addTab("Reservas", new ImageIcon(BusquedaView.class.getResource("/img/reservado.png")), scroll_table, null);
		...
		panel.addTab("Huéspedes", new ImageIcon(BusquedaView.class.getResource("/img/pessoas.png")), scroll_tableHuespedes,
				null);
