...
public class MenuPrincipalView extends JFrame {
	...
	public MenuPrincipalView() {
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipalView.class.getResource("/img/menu-img.png")));
		panel.add(imagenFondo);

		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(MenuPrincipalView.class.getResource("/img/aH-150px.png")));
		panel.add(logo);
		...
		imagenLogin.setIcon(new ImageIcon(MenuPrincipalView.class.getResource("/img/login.png")));
